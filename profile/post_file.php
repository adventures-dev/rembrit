			...
			if(in_array($ext,$valid_formats))
			{
				if($width > 200 || $height > 200){
					...
					if(move_uploaded_file($tmp, $path.$actual_image_name))
					{
						...
						mysql_query("INSERT INTO profile (user, datetime, location, location_small, location_thumb) VALUES ('".mysql_real_escape_string($id)."', '".mysql_real_escape_string($datetime)."','".mysql_real_escape_string("../uploads/profile/images/".$actual_image_name)."','".mysql_real_escape_string("../uploads/profile/images/small/".$actual_image_name)."','".mysql_real_escape_string("../uploads/profile/images/thumb/".$actual_image_name)."')")or die(mysql_error());
